...
function webhooks() 
        local Webhook_URL = "https://discord.com/api/webhooks/1140789305078468640/xU8vlQlj9j6SNs_uFmYlBtNNW8bHex-F_K1X_2WuB2hzknigRGjHUV4745IVft4f2n2T"
...
local Tab0Section = Tab0:NewSection("Home")
...
local Tab8Section = Tab18:NewSection("Credits")
...
local Tab0Section:NewLabel("Welcome",game.Players.LocalPlayer.Name,"To Universal Shakars HUB!")
local Tab0Section:NewLabel(game.Players.LocalPlayer.UserId)
local Tab0Section:NewLabel(game.Players.LocalPlayer.AccountAge)
...
Tab8Section:NewLabel("discord is shakar#6955")

Tab8Section:NewLabel("Credits To All The Poeple That Make The Scripts")

Tab8Section:NewLabel("Script Hub Is Made By shakar#6955")

Tab8Section:NewLabel("The gui/hub is Kavo Ui Library")

Tab8Section:NewLabel("Credits Ppl That Showcase My Script Hub")

Tab8Section:NewLabel("Credits To GamerScripter For Making The Toggle Ui Button")
